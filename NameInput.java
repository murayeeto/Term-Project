...
public class NameInput extends Inputs
{
    ...
    //Creates a filewriter object that will read and write the file, "name.txt".
    //This avoids creating new filewriters each time you want to read name.txt (saves resources)
    static {
        try {
